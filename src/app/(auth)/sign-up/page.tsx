...
export default function SignUpPage() {
  ...
  return (
    <div className="w-full max-w-[440px] mx-auto">
      <AuthHeader
        title={"Créez du contenu{italic}viral."}
        subtitle="Des idées de Reels virales pour votre salon de thé — propulsées par l'IA et les données de vos concurrents."
      />
      ...
      <GlassCard>
        ...
        >
          ...
          <motion.div variants={formItemVariants}>
            ...
            />
            <p className="text-[11px] text-faded mt-1.5 ml-1">
              8+ caractères &middot; 1 majuscule &middot; 1 chiffre
            </p>
          </motion.div>
